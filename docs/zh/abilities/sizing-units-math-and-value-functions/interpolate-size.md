...
<FeatureLinks mdn="https://developer.mozilla.org/en-US/search?q=interpolate-size%20CSS" caniuse="https://caniuse.com/?search=interpolate-size" status="Values/Box Sizing" label="参考链接" />
