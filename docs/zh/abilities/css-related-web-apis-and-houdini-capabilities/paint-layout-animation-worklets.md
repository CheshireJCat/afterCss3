...
<FeatureLinks mdn="https://developer.mozilla.org/en-US/search?q=Paint%2FLayout%2FAnimation%20Worklets%20CSS" caniuse="https://caniuse.com/?search=Paint%2FLayout%2FAnimation%20Worklets" status="Houdini，支持差异较大" label="参考链接" />
...
- 当你需要解决「浏览器渲染管线扩展点。」这类问题时，可以优先考虑它。
...
- 成熟度 / 来源: Houdini，支持差异较大
- 原始代表语法: `paint(worklet-name), CSS.paintWorklet.addModule(...)`
- 本分类序号：10 / 11
