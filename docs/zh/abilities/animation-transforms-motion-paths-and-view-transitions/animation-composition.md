...
<FeatureLinks mdn="https://developer.mozilla.org/en-US/search?q=animation-composition%20CSS" caniuse="https://caniuse.com/?search=animation-composition" status="Animations 2" label="参考链接" />
...
- 当你需要解决「多个动画之间的合成模式。」这类问题时，可以优先考虑它。
...
- 分类: 动画、变换、运动路径与视图过渡
- 成熟度 / 来源: Animations 2
- 原始代表语法: `animation-composition: add | accumulate | replace;`
- 本分类序号：8 / 14
